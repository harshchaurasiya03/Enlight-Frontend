  ...
  return (
    <section className="bg-white mt-6 p-6 rounded shadow-sm">
        ...
        <div>
          <ul className="space-y-2 text-sm">
            <li>
              ...
              <span className="inline-block bg-blue-100 text-blue-700 px-2 py-0.5 rounded ml-2 text-xs">
                Selling
              </span>
            </li>
            <li>
      ...
      <div className="mt-4 text-sm text-gray-700">
        <p>
          A profoundly special project amidst history and Istanbul. In the heart
          of the Historical Peninsula, Select Lifestyle Alternatives ranging
          from 1+1 to 6+1, in limited numbers... A timeless aesthetic enriched
          in perfect details.
        </p>
        ...
        <ul className="list-disc list-inside mt-2 text-sm space-y-1">
          ...
          <li>
            1+1 to 6+1 very special, suitable for all needs loft apartments.
          </li>
        </ul>
      </div>
    </section>
...
function ProjectFAQ() {
  const faqs = [
    ...
    {
      q: "What should I look for in a rental property?",
      a: "Location, neighbourhood amenities, rental yield, and maintenance costs.",
    },
  ];
...
function ProjectContactForm() {
  ...
  return (
    <div className="bg-white rounded shadow p-6 border">
      ...
      />
      <button className="w-full bg-blue-600 hover:bg-blue-400 text-white py-2 rounded">
        Send Message
      </button>
    </div>
  );
  ...
  return (
    <section className="mt-6 bg-white p-6 rounded shadow-sm">
      ...
      <textarea
        ...
        placeholder="Enter your message"
      />
      <button className="bg-gray-200 text-gray-700 px-3 py-2 rounded">
        Submit review
      </button>
    </section>
  );
  ...
  return (
    <footer className="border-t mt-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 text-sm text-gray-500">
        © 2025 Enlight — All rights reserved
      </div>
    </footer>
  );
}
