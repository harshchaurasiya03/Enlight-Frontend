...
const Footer: React.FC = () => {
  return (
    <footer className="bg-gray-900 text-white">
      ...
      <div className="w-full px-4 flex-justify-between py-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        {/* Section 1 */}
        <div>
      ...
      {/* Bottom Bar */}
      <div className="border-t border-gray-700 py-6 px-4 sm:px-8 lg:px-16 flex flex-col md:flex-row justify-between items-start md:items-center">
        {/* Left Links */}
        <div className="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-6 text-gray-400 text-sm mb-4 md:mb-0">
